...
public class AlgorithmsComparison {
    public static void main(String[] args) {
        ...
        Song[] songsArray = getAllSongs("C:/Users/user/Desktop/task1/src/song_plays.csv"); //ensure the song_plays.csv is in the same folder as this java file
    ...
    private static Song[] quickSort(Song[] songsArray) {
        ...
        // Left will store all songs whose views are less than or equal to the views
        ...
        // Select a pivot. It can be any element but for simplicity,
        ...
        // Create arrays with equal size as their corresponding arraylists
    ...
    public static Song[] concatenate(Song[] leftArr, Song pivot, Song[] rightArr) {
        ...
        i++;
        // j will be iterating over the rightArr while i will be still
    ...
    private static Song[] getAllSongs(String fileName) {
        // An arraylist to contain all the songs as instances of the song object
